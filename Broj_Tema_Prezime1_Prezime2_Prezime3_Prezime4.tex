...
Neka je zadat graf $G = (V, E)$, gde je $V$ skup čvorova, a $E$ skup grana tog grafa. 
...
MACOL \cite{lu2010memetic} predstavlja primer memetskog algoritma za rešavanje problema bojenja grafa. 
MACOL se sastoji od 4 glavne komponente, \textit{generatora inicijalne populacije}, \textit{tabu pretrage}, \textit{operatora ukrštanja} u kome učestvuje više jedinki i \textit{pravila ažuriranja populacije}. 
Inicijalnu populaciju mogu činiti jedinke koje predstavljaju nedopustiva rešenja. Tabu pretraga \cite{tabu_pretraga_miskovic} se zatim koristi za unapređivanje svake jedinke, i eventualno ispravljanje nedopustivih rešenja. 
Operator ukrštanja konstruiše nova k-bojenja i zatim koristi tabu pretragu radi daljeg unapređivanja novih jedinki. 
